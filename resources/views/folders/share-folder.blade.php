            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-12 h4">Share {{$folder->users_name}}</div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <form action="{{route('folders.share-folder',['folder'=>$folder])}}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        @if($usersToChoose->isEmpty())
                                            <p class="h5">There is no more users to share folder with!</p>
                                        @else
